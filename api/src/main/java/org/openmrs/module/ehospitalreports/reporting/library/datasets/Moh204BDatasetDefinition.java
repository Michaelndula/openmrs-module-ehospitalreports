...
@Component
public class Moh204BDatasetDefinition extends eHospitalBaseDataSet {
	...
	public DataSetDefinition constructMoh204BDatasetDefinition() {
		PatientDataSetDefinition dsd = new PatientDataSetDefinition();
		dsd.setName("MOH204B");
		dsd.addParameters(getParameters());
		dsd.setDescription("Out Patient Report for Adults");
	...
	private DataDefinition getRevisit() {
		CalculationDataDefinition cd = new CalculationDataDefinition("OPD Revisit", new RevisitPatientCalculation());
