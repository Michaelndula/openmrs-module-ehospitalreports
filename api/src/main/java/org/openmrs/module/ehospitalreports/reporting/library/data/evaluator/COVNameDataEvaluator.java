...
/**
 * Evaluates COVName Data Definition
 */
@Handler(supports = COVNameDataDefinition.class, order = 50)
public class COVNameDataEvaluator implements PersonDataEvaluator {
