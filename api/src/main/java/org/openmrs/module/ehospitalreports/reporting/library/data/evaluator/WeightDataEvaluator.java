...
/**
 * Evaluates Weight Data Definition
 */
...
public class WeightDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "SELECT client_id, MID(MAX(CONCAT(encounter_datetime, weight)), 20) as weight FROM ehospital_etl.ehospital_flat_encounter_moh_triage_report "
