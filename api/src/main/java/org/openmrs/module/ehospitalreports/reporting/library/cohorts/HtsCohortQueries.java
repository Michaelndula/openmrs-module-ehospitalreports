...
public class HtsCohortQueries {
	...
	public CohortDefinition getPatientsWithEncounterAndNoObs(List<EncounterType> encounters, TimeQualifier timeQualifier,
		...
		cd.addSearch("DateObs", eHospitalReportUtils.map(commonCohortQueries.getPatientsWithObs(questions),
		    "startDate=${startDate},endDate=${endDate},location=${location}"));
		cd.addSearch("hasEncounter", eHospitalReportUtils.map(sharedCohortQueries.hasEncounters(encounters, timeQualifier),
