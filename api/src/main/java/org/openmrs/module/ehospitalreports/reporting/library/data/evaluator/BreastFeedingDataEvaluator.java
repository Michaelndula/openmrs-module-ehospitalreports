...
/**
 * Evaluates BreastFeeding Data Definition
 */
@Handler(supports = BreastFeedingDataDefinition.class, order = 50)
public class BreastFeedingDataEvaluator implements PersonDataEvaluator {
