...
public class CalculationUtils {
	 ...
	 */
	public static EvaluatedCohort evaluateWithReporting(CohortDefinition cohortDefinition, Collection<Integer> cohort,
	...
	/**
	 * Returns the reporting {@link org.openmrs.module.reporting.evaluation.EvaluationContext}
	 * stored in calculationContext, creating and storing a new one if necessary. (Note: for now we
	 * never store this, and always return a new one)
	 * 
	 * @param calculationContext the calculation context
	 * @param cohort the patient ids
	 * @param parameterValues the parameters for the reporting context
	 ...
	 * they are added with a null result
	 * 
