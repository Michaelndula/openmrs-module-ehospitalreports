...
@Component
public class ListOfClientsWithHvlWhoReceivedDSD extends eHospitalBaseDataSet {
	...
	public DataSetDefinition getEac1Session() {
		...
		sqlDataSetDefinition
		        .setSqlQuery("SELECT "
		                ...
		                + " LEFT JOIN (select c.client_id,c.client_breastfeeding as breastfeeding,c.client_pregnant as pregnant, row_number() over (partition by c.client_id order by DATE(c.encounter_datetime) desc) as seqnum"
