...
/**
 * Evaluates TPT Eligible date Data Definition
 */
@Handler(supports = TPTEligibleDateDataDefinition.class, order = 50)
public class TPTEligibleDateDataEvaluator implements PersonDataEvaluator {
