...
@Component
public class setupMerTxCurrTxNewIndicatorsReport extends eHospitalDataExportManager {
	
	private final MerIndicatorsDatasetDefinition merIndicatorsDatasetDefinition;
	
	@Autowired
	public setupMerTxCurrTxNewIndicatorsReport(
	    org.openmrs.module.ehospitalreports.reporting.library.datasets.MerIndicatorsDatasetDefinition merIndicatorsDatasetDefinition) {
